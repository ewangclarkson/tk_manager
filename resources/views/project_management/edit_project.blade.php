...
@section('title')
    @lang('project.edit_project_title')
@endsection
            ...
            <div class="profile__info" style="width: 100%;">
                    ...
                    <div class="card bg-green card--inverse">
                        <div class="card-body c-ewangclarks ">
                            <h3 class="card-text text-white text-center">
                                {{ trans('project.edit_project_title') }}
                            </h3>
                        </div>
                    </div>
                </div>
                <div class="profile">
                    ...
                    <form method="post" enctype="multipart/form-data"
                          action="{{ trans('settings/routes.edit_project') . '/' . \App\Encrypter::encode($project->project_id)}}">
                        @csrf
                        <ul class="icon-list">
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="form-group" style="position: relative;top: 14px;">
                                            ...
                                            <input type="text" name="desc" class="form-control"
                                                   id="desc" value="{{ $project->project_des }}">
                                            <i class="form-group__bar"></i>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group">
                                            ...
                                            <select class="select2" name="owner">
                                                {!! \App\User::getEmployeesSelectOptions($project->project_leader)!!}
                                            </select>
                                        </div>
                                    </div>
                                </div>
