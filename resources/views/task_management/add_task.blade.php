            ...
            <div class="profile__info" style="width: 100%;">
                ...
                <div class="profile">
                    ...
                    <form method="post" enctype="multipart/form-data"
                          action="{{ trans('settings/routes.add_task')}}">
                        @csrf
                        <ul class="icon-list">
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="form-group">
                                            ...
                                            <select class="select2" name="priority">
                                                {!! \App\Task::getPrioritySelectOptions()!!}
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group">
                                            ...
                                            <select class="select2" name="project">
                                                {!! \App\Project::getProjectSelectOptions()!!}
                                            </select>
                                        </div>
                                    </div>
                                </div>
