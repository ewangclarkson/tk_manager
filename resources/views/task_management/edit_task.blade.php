            ...
            <div class="profile__info" style="width: 100%;">
                ...
                <div class="profile">
                    ...
                    <form method="post" enctype="multipart/form-data"
                          action="{{ trans('settings/routes.edit_task') . '/' . \App\Encrypter::encode($task->task_id)}}">
                        @csrf
                        <ul class="icon-list">
                            <li>
                                <div class="row">
                                    <div class="col-sm-5">
                                        <div class="form-group" style="position: relative;top: 14px;">
                                            <label for="name"
                                                   style="color: black;">@lang('task.name')</label>
                                    ...
                                    <div class="col-sm-5">
                                        <div class="form-group">
                                            <label for="priority"
                                                   style="color: black;">@lang('task.priority')</label>
                                            <select class="select2" name="priority">
                                                {!! \App\Task::getPrioritySelectOptions($task->priority_id)!!}
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-5">
                                        <label class="p-2" style="color: black;"
                                               for="admission-date">@lang('task.start_date')
                                            <br></label>
                                        <div class="input-group">
                                            ...
                                            <input type="date" class="form-control hidden-md-up"
                                                   placeholder="@lang('task.pick_a_date')">
                                    ...
                                    <div class="col-sm-5">
                                        <label class="p-2" style="color: black;"
                                               for="end_date">@lang('task.end_date')
                                            <br></label>
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="zmdi zmdi-calendar"></i></span>
                                ...
                                <div class="row">
                                    <div class="col-sm-10">
                                        <div class="form-group">
                                            <label for="program"
                                                   style="color: black;">@lang('task.select_project')</label>
                                            <select class="select2" name="project">
                                                {!! \App\Project::getProjectSelectOptions($task->projects_project_id)!!}
                                            </select>
                                        </div>
                                    </div>
                                </div>
