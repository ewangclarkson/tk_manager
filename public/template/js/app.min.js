    ...
    if ($("#data-table")[0]) {
        $("#data-table").DataTable({
            ...
            initComplete: function (a, b) {
                $(this).closest(".dataTables_wrapper").find(".dataTables__top").prepend('<div class="dataTables_buttons hidden-sm-down actions c-ewangclarks"><span style="color: white" class="actions__item zmdi zmdi-print" data-table-action="print" /><span style="color: white"  class="actions__item zmdi zmdi-fullscreen" data-table-action="fullscreen" /><div class="dropdown actions__item"><i style="color: white"  data-toggle="dropdown" class="zmdi zmdi-download" /><ul class="dropdown-menu dropdown-menu-right"><!--<a href="" class="dropdown-item" data-table-action="excel"><i class="zdmi zmdi-cloud-download"></i> Download Excel (.xlsx)</a>--><a href="" class="dropdown-item" data-table-action="csv"><i class="zdmi zmdi-cloud-download"></i> Download CSV (.csv)</a></ul></div></div>')
            }
        ...
        if ($("#data-tableaux")[0]) {
            $("#data-tableaux").DataTable({
                autoWidth: !1,
                responsive: !0,
                lengthMenu: [[15, 30, 45, -1], ["15 Rangs", "30 Rangs", "45 Rangs", "Tous les donnes"]],
                language: {searchPlaceholder: "Cherchez les donne..."},
                sDom: '<"dataTables__top"lfB>rt<"dataTables__bottom"ip><"clear">',
                buttons: [{extend: "excelHtml5", title: " "}, {
                    extend: "csvHtml5",
                    title: " "
                ...
                initComplete: function (a, b) {
                    $(this).closest(".dataTables_wrapper").find(".dataTables__top").prepend('<div class="dataTables_buttons hidden-sm-down actions c-ewangclarks"><span style="color: white" class="actions__item zmdi zmdi-print" data-table-action="print" /><span style="color: white"  class="actions__item zmdi zmdi-fullscreen" data-table-action="fullscreen" /><div class="dropdown actions__item"><i style="color: white"  data-toggle="dropdown" class="zmdi zmdi-download" /><ul class="dropdown-menu dropdown-menu-right"><!--<a href="" class="dropdown-item" data-table-action="excel"><i class="zdmi zmdi-cloud-download"></i> Download Excel (.xlsx)</a>--><a href="" class="dropdown-item" data-table-action="csv"><i class="zdmi zmdi-cloud-download"></i> Telechagez CSV (.csv)</a></ul></div></div>')
                }
            }), $(".dataTables_filter input[type=search]").focus(function () {
                $(this).closest(".dataTables_filter").addClass("dataTables_filter--toggled")
            }), $(".dataTables_filter input[type=search]").blur(function () {
